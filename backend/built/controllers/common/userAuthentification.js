...
var Authentificate = /** @class */ (function () {
    ...
    Authentificate.authMiddleware = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var token, decode, id, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        decode = _a.sent();
                        id = mongodb_1.ObjectId.createFromHexString(decode._id);
                        req.authData = { _id: id };
                        next();
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
                        console.log(error_1);
                        return [2 /*return*/, res.status(400).json({ text: "Error 400: Token invalid", err: error_1 })];
                    case 4: return [3 /*break*/, 6];
                    case 5: return [2 /*return*/, res.status(400)
                            .json({
    ...
    Authentificate.parseToken = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
