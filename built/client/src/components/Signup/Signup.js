...
var Signup = /** @class */ (function (_super) {
    ...
    function Signup() {
        ...
        _this.send = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, pseudo, email, password, cpassword, data, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.state, pseudo = _a.pseudo, email = _a.email, password = _a.password, cpassword = _a.cpassword;
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, API_1.default.signup({ pseudo: pseudo, email: email, password: password })];
                    case 2:
                        data = (_b.sent()).data;
    ...
    Signup.prototype.render = function () {
        var _a = this.state, pseudo = _a.pseudo, email = _a.email, password = _a.password, cpassword = _a.cpassword;
        ...
        <react_bootstrap_1.FormGroup controlId="pseudo" bsSize="large">
          <react_bootstrap_1.FormLabel>Pseudo</react_bootstrap_1.FormLabel>
          <react_bootstrap_1.FormControl autoFocus type="pseudo" value={pseudo} onChange={this.handleChange}/>
	</react_bootstrap_1.FormGroup>
        ...
        <react_bootstrap_1.FormGroup controlId="cpassword" bsSize="large">
          <react_bootstrap_1.FormLabel>Confirm Password</react_bootstrap_1.FormLabel>
          <react_bootstrap_1.FormControl value={cpassword} onChange={this.handleChange} type="password"/>
        </react_bootstrap_1.FormGroup>
