...
var Posts = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        lastPosts = new Array();
                        return [4 /*yield*/, database_service_js_1.DBVars.posts.find({
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, database_service_js_1.DBVars.posts.updateOne({ _id: thisAuthorId }, {
                                lastPosts: lastPosts
                            })];
                    case 3:
                        updatedUser = _a.sent();
    ...
    Posts.add = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var thisAuthor, _a, title, body, authors, visible, validators, post, retPost, error_2;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        authors.forEach(function (author) {
                            console.log(author);
                            var valAuthor = (author != thisAuthor) ? { authorId: author, validate: false } : { authorId: author, validate: true };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 9, , 10]);
                        valAuth = { authorId: thisAuthorId, validate: true };
                        return [4 /*yield*/, database_service_js_1.DBVars.posts.findOne({ $and: [{ _id: postId }, { "validators.author": thisAuthorId }] })];
                    case 2:
                        postData = _a.sent();
                        updatedValidators_1 = new Array();
                        postData.validators.forEach(function (validator) {
                            if (validator.author == thisAuthorId) {
                                updatedValidators_1.push({ authorId: thisAuthorId, validate: true });
                            }
                            else {
                                updatedValidators_1.push({ authorId: validator.author, validate: validator.validate });
                            }
                        });
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 7, , 8]);
                        return [4 /*yield*/, database_service_js_1.DBVars.posts.findOneAndUpdate({ $and: [{ _id: postId }, { validators: postData.validators }] }, { validators: updatedValidators_1 }, { returnDocument: "after" })];
                    case 4:
                        ...
                        return [4 /*yield*/, database_service_js_1.DBVars.posts.updateOne({ _id: postId }, { visible: true })];
                    case 5:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, database_service_js_1.DBVars.posts.findOneAndUpdate({ $and: [{ _id: postId }, { "authors": thisAuthorId }] }, updatedValues)];
                    case 2:
                        wallPost = _a.sent();
    ...
    Posts.get = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var reqParams, wallPosts, returnedData, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, res.status(200).json({ text: "Status 200: Success", returnedData: returnedData })];
                    case 2:
                        error_6 = _a.sent();
                        return [2 /*return*/, res.status(400).json({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, database_service_js_1.DBVars.posts.deleteMany({})];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = (req.body._id);
                        return [4 /*yield*/, database_service_js_1.DBVars.posts.deleteOne({ "_id": new mongodb_1.ObjectId(id) })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, res.status(200).json({ text: "Status 200: Success" })];
                    case 2:
