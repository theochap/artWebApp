...
function ConnectToDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var dbConnString, Client, db, usersCollection, postsCollection;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    db = Client.db(config_1.default.get("db.name"));
                    usersCollection = db.collection("Users");
                    postsCollection = db.collection("Posts");
                    exports.DBVars.users = usersCollection;
                    exports.DBVars.posts = postsCollection;
                    exports.DBVars.client = Client;
                    return [4 /*yield*/, usersCollection.createIndexes([{ key: { pseudo: 1 }, unique: true }, { key: { email: 1 }, unique: true }])];
                case 2:
                    _a.sent();
